...
> **Library Management** is a project that uses OOP classes to create and simulate a real-life library.
...
```sh
  cd my-folder
  git clone git@github.com:Shakir-Hussain12/OOP-Library.git
```
...
To add an [issue](https://github.com/Shakir-Hussain12/OOP-Library/issues)
